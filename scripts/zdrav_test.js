...
$(function () {
	...
	var questions = [
		...
		{
			name: 'food',
			title: 'Питание. Как Вы сами оцениваете?',
			type: 'radio',
			answers: [ 
		...
		{
			name: 'cold',
			title: 'Как часто вы болеете просутдными заболеваниями?',
			type: 'radio',
			answers: [ 
		...
		{
			name: 'dead',
			title: 'Причины смерти кровных родственников (родители, дедушки, бабушки, братья. сестры )',
			type: 'checkbox',
			answers: [ 
		...
		{
			name: 'bodycheck',
			title: 'Когда в последний раз проходили профилактический медосмотр?',
			type: 'radio',
			answers: [ 
		...
		/* 17 */
		{
			...
			title: 'Что вам мешает заниматься профилактикой здоровья?',
			type: 'radio',
			answers: [ 
